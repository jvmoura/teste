...
public class MipsFrame extends Frame {
    ...
    public Tree.Exp1 externalCall(String s, List<Tree.Exp1> args) {
	...
	*/
    ...
    private static Tree.MOVE MOVE(Tree.Exp1 d, Tree.Exp1 s) {
	...
	*/
	...
	if (spills != null) {
		...
		Tree.Exp1 exp = allocLocal(true).exp(TEMP(FP));
